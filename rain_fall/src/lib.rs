    ...
    fn bar(s: &str) -> Vec<RainFallVals> {
        ...
        */
        s.trim_end()
            ...
            .map(|i| (i[0].clone(), foo(&i[1])))
            .collect::<Vec<RainFallVals>>()
    }
...
"#;
    ...
    fn basic_tests() {
        let da_ta = &da_ta();
        assert_fuzzy_mean("London", da_ta, 51.199_999_999_999_996);
        assert_fuzzy_mean("Beijing", da_ta, 52.416_666_666_666_664);
        assert_fuzzy_var("London", da_ta, 57.428_333_333_333_74);
        assert_fuzzy_var("Beijing", da_ta, 4_808.371_388_888_89);
    }
}
